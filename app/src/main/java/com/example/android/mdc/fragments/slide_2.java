...
public class slide_2 extends Fragment {
    ...
    public static slide_2 newInstance() {
        return new slide_2();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_slide_2, container, false);
        Typeface robotoLight = Typeface.createFromAsset(getContext().getAssets(), "fonts/Roboto-Light.ttf");
        slide_title  = (TextView) v.findViewById(R.id.slide_2_title);
        slide_desc  = (TextView) v.findViewById(R.id.slide_2_desc);
